...
if __name__=="__main__":
    ...
    if( case  == 'pub-sub-test'):
        ...
        msg_interval_test(broker=broker, url='iotgroup4:iot4@80.196.35.233:5672', iterations=1000, stepsize=100, interval=0.1, \
                                                fileName=['{0}_msg_interval_test_{1}_{2}' .format(broker, date, device), '{0}_msg_time_test_{1}_{2}' .format(broker, date, device)])
        pub_sub_test(broker=broker, url='iotgroup4:iot4@80.196.35.233:5672', iterations=1000, stepsize=1, fileName='{0}_pub_sub_ratio_test_{1}_{2}' .format(broker, date, device))
